...
%Další konceptem je interakce s herní deskou, kdy hráč interaguje pomocí gest nebo stisknutím virtuálních tlačítek na desce. Tento koncept štěpí interakční část a zobrazovací a pro uživatele může být v některých případech obzvlášť nepříjemný. Z tohoto důvodu budu využívat koncept zmíněný prvně.
%
